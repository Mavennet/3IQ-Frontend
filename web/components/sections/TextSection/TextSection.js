...
import MemberCard from '../TeamsDisplay/MemberCard/MemberCard'
          ...
          <Grid container>
            <Grid item sm={videoSrc ? 8 : 12} xs={12}>
              <Box sx={{ pt: 5, pr: videoSrc && { md: 20, sm: 0 }, align: 'left' }}>
                ...
                {localeButton && (
                  <Box sx={{ display: 'flex', justifyContent: isButtonCentralized ? 'center' : 'flex-start' }} onClick={() => setOpen(true)}>
